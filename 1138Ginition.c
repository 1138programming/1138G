...
#pragma config(Motor,  port8,           rightLiftMotor, tmotorVex393_MC29, openLoop)
...
{
	motor[rightFrontMotor]=-vexRT(Ch2Xmtr2);
	motor[rightRearMotor]=-vexRT(Ch2Xmtr2);
	}
 else
{
	motor[rightFrontMotor]=0;
